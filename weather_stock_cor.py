...
#-----Chicago data
df_weather2 = df_weather[['DATE','REPORTTPYE','DAILYWeather','DAILYAverageDryBulbTemp','DAILYAverageRelativeHumidity','DAILYAverageStationPressure','DAILYAverageWindSpeed']].loc[df_weather['REPORTTPYE']=='SOD'].loc[df_weather['STATION_NAME']=='CHICAGO OHARE INTERNATIONAL AIRPORT IL US']
df_weather2.rename(columns={'DATE':'Date'}, inplace=True)
print(df_weather2.head())
#-----San Francisco data
df_weather3 = df_weather[['DATE','REPORTTPYE','DAILYWeather','DAILYAverageDryBulbTemp','DAILYAverageRelativeHumidity','DAILYAverageStationPressure','DAILYAverageWindSpeed']].loc[df_weather['REPORTTPYE']=='SOD'].loc[df_weather['STATION_NAME']=='SAN FRANCISCO INTERNATIONAL AIRPORT CA US']
...
"""
next steps:
    1-plot charts and combine
    2-use funtion where applicable
